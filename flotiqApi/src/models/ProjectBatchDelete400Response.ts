 ...
 */
export function instanceOfProjectBatchDelete400Response(value: object): value is ProjectBatchDelete400Response {
    ...
    if (flotiqContentType) {
        const typeSlug = flotiqContentType.split('_')
            ...
            .join('');
        return 'ProjectBatchDelete400Response' === typeSlug;
    }
    return true;
}
